...
int register_com_android_internalstoragemgmt(JNIEnv *env) {
    if (jniRegisterNativeMethods(
            env, "com/android/internalstoragemgmt/MeasurementUtils", g_methods, NELEM(g_methods)) < 0) {
        return JNI_ERR;
    }
...
int JNI_OnLoad(JavaVM *jvm, void* reserved) {
    ...
    return android::register_com_android_internalstoragemgmt(env);
}
