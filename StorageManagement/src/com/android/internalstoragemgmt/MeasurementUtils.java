...
/*
 * Directory measurement utility, copy from frameworks/base/packages/DefaultContainerService
 * Load same jni library to measure.
 */
package com.android.internalstoragemgmt;

public class MeasurementUtils {
    static {
        System.loadLibrary("internalstoragemgmt_jni");
    }
