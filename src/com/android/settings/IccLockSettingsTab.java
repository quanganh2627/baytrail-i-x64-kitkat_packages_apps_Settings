...
public class IccLockSettingsTab extends TabActivity implements TabHost.OnTabChangeListener {
    private static final String LOG_TAG = "IccLockSettingsTab";
    private static final boolean DBG = false;

    private static final int TAB_INDEX_SIM_A = 0;
    private static final int TAB_INDEX_SIM_B = 1;

    private static final String PREF_LAST_MANUALLY_SELECTED_TAB = "last_sim_lock_tab";
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.dual_icc_lock_tab); //ref
    ...
    SharedPreferences getPhoneDefaultPref() {
        ...
        if (DBG) log("getDefaultPref from phone process");
        if (mPhoneContext == null) {
            ...
            try {
                ...
                if (DBG) log("NameNotFoundException:" + e);
            }
        }
    ...
    private void restoreLastTab() {
        ...
        if (DBG) log("getDefaultSharedPref");
        final SharedPreferences prefs = getPhoneDefaultPref();
    ...
    protected void onPause() {
        ...
        final SharedPreferences.Editor editor = getPhoneDefaultPref().edit();
    ...
    private void setupTab(int slot) {
        ...
        intent.setClass(this, IccLockSettings.class);

        String title = slot == 1 ? getString(R.string.tab_b_title) :
                getString(R.string.tab_a_title);

        int iconId = slot == 0 ? R.drawable.ic_tab_icc_lock_a : R.drawable.ic_tab_icc_lock_b; // ref
